...
const PokemonCards = ({ img, name, id, types }) => {
    ...
    const { selected, addPokemon } = useContext(ComparePokemonContext);
    ...
    return (
        <>
            ...
            <button className={`mt-2 rounded px-2 text-white ${isSelected ? 'bg-orange-600' : 'bg-[#1f2937]'}`} onClick={() => addPokemon(id)}>Compare</button>
